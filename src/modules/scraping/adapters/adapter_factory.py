...
from src.modules.scraping.adapters.palestine_mohe_adapter import PalestineMoHEAdapter
...
class AdapterFactory:
    ...
    "palestine_mohe": PalestineMoHEAdapter
    }
    ...
    def create_adapter(
        ...
        if clean_name in cls._registry:
            ...
            # Palestine MoHE is NOT a WordPress API adapter
            if adapter_cls is PalestineMoHEAdapter:
                return adapter_cls(
                    source_id=source_id,
